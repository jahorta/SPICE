...
using namespace spice::modeling::Testing::Slice4;
...
TEST(SpiceModelingStage4, ReadsChunkAttachHeaderBoundsAndVertexChunks) {
...
TEST(SpiceModelingStage4, AttachDispatchAllowsOnlySA2ChunkForThisSlice) {
...
TEST(SpiceModelingStage4, NodeReadCanResolveChunkAttachWhenRequested) {
...
TEST(SpiceModelingStage4, ReadsChunkStripCornersWithTexcoordsAndAttributes) {
