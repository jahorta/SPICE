...
using namespace spice::modeling::Testing::Slice2;
...
TEST(SpiceModelingStage2, ScansNjBlocksInOrderAndClassifiesRoles) {
...
TEST(SpiceModelingStage2, DetectsBigEndianBlockSizesButKeepsHeaderLittleEndian) {
...
TEST(SpiceModelingStage2, DoesNotClassifyGJHeadersForSkiesScope) {
...
TEST(SpiceModelingStage2, StopsOnZeroHeaderOrSize) {
...
TEST(SpiceModelingStage2, ReportsTruncatedBlockHeader) {
...
TEST(SpiceModelingStage2, ReadsMetadataVersion3Shell) {
...
TEST(SpiceModelingStage2, ReadsMetadataWeightCounts) {
