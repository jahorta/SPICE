...
using namespace spice::modeling::Testing::Slice3;
...
TEST(SpiceModelingStage3, ReadsNodeTreeAndMaintainsRelationships) {
...
TEST(SpiceModelingStage3, ReadsEulerTransformsFromBams32) {
...
TEST(SpiceModelingStage3, ReadsQuaternionRotationLayout) {
    std::vector<std::byte> data(0x34);
...
TEST(SpiceModelingStage3, SetChildRequiresRootSiblingAndAssignsParentAcrossSiblings) {
