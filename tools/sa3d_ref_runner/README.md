...
- This is intended for SpiceGrinder A/B flows that pass one manifest per fixture per slice.
...
```bash
dotnet run --project tools/sa3d_ref_runner/SA3DRefRunner.csproj -- run-one --input SpiceGrinder/inputs/example.mld --out SpiceGrinder/parsed
```
