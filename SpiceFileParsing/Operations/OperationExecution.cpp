...
void emit(
    ...
    const spice::fileparsing::EventLevel level,
    Values&&... values) {
    if (!context.report) {
        return;
    }
...
struct DirectoryOperation {
    ...
    spice::fileparsing::DirectoryPaths paths{};
    ...
    spice::fileparsing::GvrEncodingSettings encoding{};
    spice::fileparsing::AklzPolicy importAklz = spice::fileparsing::AklzPolicy::Preserve;
    spice::fileparsing::ContentGraphProjection contentGraphProjection =
        spice::fileparsing::ContentGraphProjection::Full;
};

spice::gvm::ir::AklzPolicy toRuntimeAklzPolicy(spice::fileparsing::AklzPolicy policy);
spice::gvm::model::TextureFormat toRuntimeTextureFormat(spice::fileparsing::GvrTextureFormat format);
spice::gvm::model::PaletteFormat toRuntimePaletteFormat(spice::fileparsing::GvrPaletteFormat format);
...
int executeDirectoryOperation(
    ...
    if (!std::filesystem::exists(inputDir) || !std::filesystem::is_directory(inputDir)) {
        emit(context, spice::fileparsing::EventLevel::Error, "Input directory not found: ", inputDir);
        return 1;
    }
    if (operation.kind == DirectoryOperationKind::ReplaceGvrBatch
        ...
        emit(context, spice::fileparsing::EventLevel::Error,
    ...
    if (operation.kind == DirectoryOperationKind::CreateGvrBatch
        ...
        try {
            ...
            emit(context, spice::fileparsing::EventLevel::Error,
                "[SpiceFileParsing] ERROR: ", ex.what());
            return 1;
        }
        emit(context, spice::fileparsing::EventLevel::Progress,
            "[SpiceFileParsing] Step 4/4: Finalizing summary.");
        emit(context, spice::fileparsing::EventLevel::Info, "SpiceFileParsing finished.");
        emit(context, spice::fileparsing::EventLevel::Info, "FilesProcessed=", filesProcessed);
        emit(context, spice::fileparsing::EventLevel::Info, "inputDir=", inputDir);
        emit(context, spice::fileparsing::EventLevel::Info, "outputDir=", outputDir);
        return 0;
    }
    ...
    for (const auto& entry : std::filesystem::directory_iterator(inputDir)) {
        ...
        if (operation.kind == DirectoryOperationKind::ExportGvrImageIr) {
            ...
            emit(context, spice::fileparsing::EventLevel::Progress,
                "[SpiceFileParsing]   - Exporting GVR image IR: ", entry.path().filename().string());
            try {
                ...
                emit(context, spice::fileparsing::EventLevel::Warning,
                    "[SpiceFileParsing] WARNING: GVR image IR export failed for ",
        ...
        if (operation.kind == DirectoryOperationKind::ImportGvrImageIr) {
            ...
            emit(context, spice::fileparsing::EventLevel::Progress,
                "[SpiceFileParsing]   - Importing GVR image IR: ", entry.path().filename().string());
            try {
                ...
                if (!writeAllBytes(outPath, std::span<const std::uint8_t>(imported.bytes.data(), imported.bytes.size()))) {
                    emit(context, spice::fileparsing::EventLevel::Warning,
                        "[SpiceFileParsing] WARNING: failed to write imported GVR: ", outPath.string());
                }
                ...
                emit(context, spice::fileparsing::EventLevel::Warning,
                    "[SpiceFileParsing] WARNING: GVR image IR import failed for ",
                    entry.path().string(), ": ", ex.what());
            }
            continue;
        }
        ...
        if (operation.kind == DirectoryOperationKind::ExportStdJson) {
            ...
            emit(context, spice::fileparsing::EventLevel::Progress,
                "[SpiceFileParsing]   - Exporting STD JSON: ", entry.path().filename().string());
            try {
                ...
                if (!jsonOut.good()) {
                    emit(context, spice::fileparsing::EventLevel::Warning,
                        "[SpiceFileParsing] WARNING: failed to write STD JSON: ", jsonOutPath.string());
                } else {
                    ++filesProcessed;
                }
            } catch (const std::exception& ex) {
                emit(context, spice::fileparsing::EventLevel::Warning,
                    "[SpiceFileParsing] WARNING: STD JSON export failed for ",
                    entry.path().string(), ": ", ex.what());
            }
            continue;
        }
        ...
        if (operation.kind == DirectoryOperationKind::ExportSmlResearch) {
            ...
            emit(context, spice::fileparsing::EventLevel::Progress,
                "[SpiceFileParsing]   - Exporting SML research artifacts: ",
            ...
            try {
                ...
                if (operation.embeddedMldBlenderIr || operation.combinedBlenderIr) {
                            ...
                            if (parsedEmbeddedMld.blenderIrScene.has_value()) {
                                ...
                                if (operation.embeddedMldBlenderIr) {
                                    ...
                                    if (!blenderIrOut.good()) {
                                        emit(context, spice::fileparsing::EventLevel::Warning,
                                            "[SpiceFileParsing] WARNING: failed to write embedded MLD Blender IR for ",
                                ...
                                emit(context, spice::fileparsing::EventLevel::Warning,
                                    "[SpiceFileParsing] WARNING: embedded MLD Blender IR was not produced for ",
                                    entry.path().filename().string(), " record ", record.index);
                            }
                        } catch (const std::exception& ex) {
                            emit(context, spice::fileparsing::EventLevel::Warning,
                                "[SpiceFileParsing] WARNING: embedded MLD parse failed for ",
                    ...
                    if (combinedBlenderIr.has_value()) {
                        ...
                        if (!combinedOut.good()) {
                            emit(context, spice::fileparsing::EventLevel::Warning,
                                "[SpiceFileParsing] WARNING: failed to write combined SML Blender IR for ",
                                entry.path().filename().string());
                        } else {
                ...
                if (!exportResult.wroteManifest) {
                    emit(context, spice::fileparsing::EventLevel::Warning,
                        "[SpiceFileParsing] WARNING: failed to write SML embedded MLD manifest for ",
                        entry.path().string());
                }
                if (operation.commandMap && !exportResult.wroteCommandMap) {
                    emit(context, spice::fileparsing::EventLevel::Warning,
                        "[SpiceFileParsing] WARNING: no SST/SML command map was written for ",
                        entry.path().string());
                }
                if (!exportResult.wroteStageAnnotationTemplate) {
                    emit(context, spice::fileparsing::EventLevel::Warning,
                        "[SpiceFileParsing] WARNING: no SST/SML stage annotation template was written for ",
                        entry.path().string());
                }
                ++filesProcessed;
            } catch (const std::exception& ex) {
                emit(context, spice::fileparsing::EventLevel::Warning,
                    "[SpiceFileParsing] WARNING: SML embedded MLD export failed for ",
                    entry.path().string(), ": ", ex.what());
            }
            continue;
        }
        ...
        if (extension == ".sct") {
            emit(context, spice::fileparsing::EventLevel::Progress,
                "[SpiceFileParsing]   - Parsing SCT: ", entry.path().filename().string());
            ...
            if (operation.kind == DirectoryOperationKind::ExportSct) {
                ...
                if (!writeAllBytes(exportedSctPath, std::span<const std::uint8_t>(exportedSct.data(), exportedSct.size()))) {
                    emit(context, spice::fileparsing::EventLevel::Warning,
                        "[SpiceFileParsing] WARNING: failed to write SCT binary export: ",
                ...
                if (!comparison.equivalent) {
                    emit(context, spice::fileparsing::EventLevel::Warning,
                        "[SpiceFileParsing] WARNING: SCT canonical export semantic comparison failed for ",
                        entry.path().string());
                }
            }
            ++filesProcessed;
        ...
        if (extension == ".mld") {
            emit(context, spice::fileparsing::EventLevel::Progress,
                "[SpiceFileParsing]   - Parsing MLD: ", entry.path().filename().string());
            ...
            if (operation.kind == DirectoryOperationKind::InventoryMldGvrFormats) {
                ...
                try {
                    ...
                    emit(context, spice::fileparsing::EventLevel::Warning,
                        "[SpiceFileParsing] WARNING: MLD GVR format sampling failed for ",
                        entry.path().string(), ": ", ex.what());
                }
                continue;
            }
            ...
            if (operation.kind == DirectoryOperationKind::CompareMldSa3d) {
                ...
                for (const auto& block : sa3dPortParsed.extractedNjBlocks) {
                    ...
                    if (!writeAllBytes(blockInputPath, std::span<const std::uint8_t>(normalizedBlock->bytes.data(), normalizedBlock->bytes.size()))) {
                        emit(context, spice::fileparsing::EventLevel::Warning,
                            "[SpiceFileParsing] WARNING: failed to write extracted NJ block input: ",
    ...
    if (operation.kind == DirectoryOperationKind::ExportContentGraph) {
        ...
        if (operation.contentGraphProjection == spice::fileparsing::ContentGraphProjection::Sections) {
            projection = spice::contentgraph::ContentGraphProjection::Sections;
        } else if (operation.contentGraphProjection == spice::fileparsing::ContentGraphProjection::World) {
        ...
        emit(context, spice::fileparsing::EventLevel::Info,
            "[SpiceFileParsing]   - Wrote content graph: ", graphOutPath.string());
    }
    ...
    if (operation.kind == DirectoryOperationKind::InventoryMldGvrFormats) {
        ...
        emit(context, spice::fileparsing::EventLevel::Info,
            "[SpiceFileParsing]   - Wrote MLD GVR format inventory: ", jsonOutPath.string());
        emit(context, spice::fileparsing::EventLevel::Info,
            "[SpiceFileParsing]   - Wrote MLD GVR priority report: ", markdownOutPath.string());
    }
    ...
    emit(context, spice::fileparsing::EventLevel::Info, "SpiceFileParsing finished.");
    emit(context, spice::fileparsing::EventLevel::Info, "FilesProcessed=", filesProcessed);
    emit(context, spice::fileparsing::EventLevel::Info, "inputDir=", inputDir.string());
    emit(context, spice::fileparsing::EventLevel::Info, "outputDir=", outputDir.string());
...
spice::gvm::ir::AklzPolicy toRuntimeAklzPolicy(const spice::fileparsing::AklzPolicy policy) {
    switch (policy) {
    case spice::fileparsing::AklzPolicy::Preserve:
        return spice::gvm::ir::AklzPolicy::Preserve;
    case spice::fileparsing::AklzPolicy::Raw:
        return spice::gvm::ir::AklzPolicy::Raw;
    case spice::fileparsing::AklzPolicy::Compressed:
        return spice::gvm::ir::AklzPolicy::Compressed;
    }
    return spice::gvm::ir::AklzPolicy::Preserve;
}

spice::gvm::model::TextureFormat toRuntimeTextureFormat(const spice::fileparsing::GvrTextureFormat format) {
    using Source = spice::fileparsing::GvrTextureFormat;
...
spice::gvm::model::PaletteFormat toRuntimePaletteFormat(const spice::fileparsing::GvrPaletteFormat format) {
    using Source = spice::fileparsing::GvrPaletteFormat;
...
DirectoryOperation makeDirectoryOperation(const spice::fileparsing::ParseMldRequest& request) {
...
DirectoryOperation makeDirectoryOperation(const spice::fileparsing::CompareMldSa3dRequest& request) {
    DirectoryOperation operation{};
...
DirectoryOperation makeDirectoryOperation(const spice::fileparsing::ExportMldEntryListRequest& request) {
    DirectoryOperation operation{};
    operation.kind = DirectoryOperationKind::ExportMldEntryList;
    operation.paths = request.paths;
    return operation;
...
DirectoryOperation makeDirectoryOperation(const spice::fileparsing::InventoryMldGvrFormatsRequest& request) {
    DirectoryOperation operation{};
    operation.kind = DirectoryOperationKind::InventoryMldGvrFormats;
    operation.paths = request.paths;
    return operation;
...
DirectoryOperation makeDirectoryOperation(const spice::fileparsing::ParseSctRequest& request) {
    DirectoryOperation operation{};
...
DirectoryOperation makeDirectoryOperation(const spice::fileparsing::ExportSctRequest& request) {
    DirectoryOperation operation{};
...
DirectoryOperation makeDirectoryOperation(const spice::fileparsing::ExportSmlResearchRequest& request) {
    DirectoryOperation operation{};
    ...
    operation.combinedRawPlacement = request.combinedPlacement == spice::fileparsing::CombinedPlacement::Raw;
    operation.commandMap = request.commandMap;
    return operation;
}

DirectoryOperation makeDirectoryOperation(const spice::fileparsing::ExportStdJsonRequest& request) {
    DirectoryOperation operation{};
...
DirectoryOperation makeDirectoryOperation(const spice::fileparsing::ExportContentGraphRequest& request) {
    DirectoryOperation operation{};
...
DirectoryOperation makeDirectoryOperation(const spice::fileparsing::CreateGvrBatchRequest& request) {
    DirectoryOperation operation{};
...
DirectoryOperation makeDirectoryOperation(const spice::fileparsing::ReplaceGvrBatchRequest& request) {
    DirectoryOperation operation{};
    operation.kind = DirectoryOperationKind::ReplaceGvrBatch;
    operation.paths.input = request.input;
    operation.paths.output = request.output;
...
DirectoryOperation makeDirectoryOperation(const spice::fileparsing::ExportGvrImageIrRequest& request) {
    DirectoryOperation operation{};
...
DirectoryOperation makeDirectoryOperation(const spice::fileparsing::ImportGvrImageIrRequest& request) {
    DirectoryOperation operation{};
...
void finishSingleFile(
    ...
    emit(context, spice::fileparsing::EventLevel::Progress,
        "[SpiceFileParsing] Step 3/4: Wrote ", output.string());
    emit(context, spice::fileparsing::EventLevel::Progress,
        "[SpiceFileParsing] Step 4/4: Finalizing summary.");
    emit(context, spice::fileparsing::EventLevel::Info, "SpiceFileParsing finished.");
    emit(context, spice::fileparsing::EventLevel::Info, "FilesProcessed=1");
}

int executeOperationRequest(
    const spice::fileparsing::OperationRequest& request,
    spice::fileparsing::OperationContext& context) {
    emit(context, spice::fileparsing::EventLevel::Progress,
        "[SpiceFileParsing] Step 1/4: Initializing operation.");
    return std::visit(Overloaded{
        [&](const spice::fileparsing::ParseMldRequest& value) {
            return executeDirectoryOperation(makeDirectoryOperation(value), context);
        },
        [&](const spice::fileparsing::CompareMldSa3dRequest& value) {
            return executeDirectoryOperation(makeDirectoryOperation(value), context);
        },
        [&](const spice::fileparsing::ExportMldEntryListRequest& value) {
            return executeDirectoryOperation(makeDirectoryOperation(value), context);
        },
        [&](const spice::fileparsing::InventoryMldGvrFormatsRequest& value) {
            return executeDirectoryOperation(makeDirectoryOperation(value), context);
        },
        [&](const spice::fileparsing::ReplaceMldTextureRequest& value) {
            emit(context, spice::fileparsing::EventLevel::Progress,
                "[SpiceFileParsing] Step 2/4: Replacing embedded MLD texture.");
            replaceMldTextureFromPngFile(value);
            finishSingleFile(context, value.output);
            return 0;
        },
        [&](const spice::fileparsing::ExtractMldTextureGvrRequest& value) {
            emit(context, spice::fileparsing::EventLevel::Progress,
                "[SpiceFileParsing] Step 2/4: Extracting embedded MLD texture GVR.");
            extractMldTextureToGvrFile(value);
            finishSingleFile(context, value.output);
            return 0;
        },
        [&](const spice::fileparsing::ExtractMldTexturePngRequest& value) {
            emit(context, spice::fileparsing::EventLevel::Progress,
                "[SpiceFileParsing] Step 2/4: Extracting embedded MLD texture PNG.");
            extractMldTextureToPngFile(value);
            finishSingleFile(context, value.output);
            return 0;
        },
        [&](const spice::fileparsing::ParseSctRequest& value) {
            return executeDirectoryOperation(makeDirectoryOperation(value), context);
        },
        [&](const spice::fileparsing::ExportSctRequest& value) {
            return executeDirectoryOperation(makeDirectoryOperation(value), context);
        },
        [&](const spice::fileparsing::ExportSmlResearchRequest& value) {
            return executeDirectoryOperation(makeDirectoryOperation(value), context);
        },
        [&](const spice::fileparsing::ExportStdJsonRequest& value) {
            return executeDirectoryOperation(makeDirectoryOperation(value), context);
        },
        [&](const spice::fileparsing::ExportMlkCorpusRequest& value) {
            return executeMlkCorpus(value, context);
        },
        [&](const spice::fileparsing::ExportMlkBlenderIrRequest& value) {
            return executeMlkBlenderIr(value, context);
        },
        [&](const spice::fileparsing::ExportContentGraphRequest& value) {
            return executeDirectoryOperation(makeDirectoryOperation(value), context);
        },
        [&](const spice::fileparsing::ExportAlxEnemyEventsRequest& value) {
            emit(context, spice::fileparsing::EventLevel::Progress,
                "[SpiceFileParsing] Step 2/4: Importing ALX enemy events.");
            spice::alx::exportEnemyEventsCsvToJson(value.input, value.output);
            finishSingleFile(context, value.output);
            return 0;
        },
        [&](const spice::fileparsing::CreateGvrRequest& value) {
            emit(context, spice::fileparsing::EventLevel::Progress,
                "[SpiceFileParsing] Step 2/4: Creating standalone GVR.");
            createGvrFromPngFile(value.encoding, value.input, value.output);
            finishSingleFile(context, value.output);
            return 0;
        },
        [&](const spice::fileparsing::ReplaceGvrRequest& value) {
            emit(context, spice::fileparsing::EventLevel::Progress,
                "[SpiceFileParsing] Step 2/4: Replacing standalone GVR.");
            replaceGvrFromPngFile(value.encoding, value.source, value.replacement, value.output);
            finishSingleFile(context, value.output);
            return 0;
        },
        [&](const spice::fileparsing::GvrToPngRequest& value) {
            emit(context, spice::fileparsing::EventLevel::Progress,
                "[SpiceFileParsing] Step 2/4: Decoding standalone GVR to PNG.");
            convertGvrToPngFile(value.input, value.output);
            finishSingleFile(context, value.output);
            return 0;
        },
        [&](const spice::fileparsing::CreateGvrBatchRequest& value) {
            return executeDirectoryOperation(makeDirectoryOperation(value), context);
        },
        [&](const spice::fileparsing::ReplaceGvrBatchRequest& value) {
            return executeDirectoryOperation(makeDirectoryOperation(value), context);
        },
        [&](const spice::fileparsing::ExportGvrImageIrRequest& value) {
            return executeDirectoryOperation(makeDirectoryOperation(value), context);
        },
        [&](const spice::fileparsing::ImportGvrImageIrRequest& value) {
            return executeDirectoryOperation(makeDirectoryOperation(value), context);
        },
        [&](const spice::fileparsing::CompressAklzRequest& value) {
            emit(context, spice::fileparsing::EventLevel::Progress,
                "[SpiceFileParsing] Step 2/4: Compressing AKLZ.");
            runAklzUtility(value.input, value.output, false);
            finishSingleFile(context, value.output);
            return 0;
        },
        [&](const spice::fileparsing::DecompressAklzRequest& value) {
            emit(context, spice::fileparsing::EventLevel::Progress,
                "[SpiceFileParsing] Step 2/4: Decompressing AKLZ.");
