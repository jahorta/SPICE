...
namespace spice::modeling::ObjectData {
...
struct NodeReadContext {
    ...
    spice::modeling::Mesh::AttachReadContext attach_context {};
...
public:
    ...
    spice::modeling::Mesh::AttachPtr attach;
    ...
    [[nodiscard]] static NodePtr read(const Structs::EndianStackReader& reader,
        ...
        if (const auto attachAddress = read_pointer(reader, address + 4u, context.image_base)) {
            ...
            if (context.read_attach) {
                ...
                result->attach = spice::modeling::Mesh::Attach::read(reader, *attachAddress, format, context.attach_context);
            }
        }
