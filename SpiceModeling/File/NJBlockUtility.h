...
struct NJBlockScanResult {
    ...
    ::spice::modeling::Structs::Endian size_endian = ::spice::modeling::Structs::Endian::Little;
};
...
struct NJBlockPayload {
    ...
    ::spice::modeling::Structs::EndianStackReader reader;
...
public:
    ...
    [[nodiscard]] static NJBlockScanResult ScanBlocks(std::span<const std::byte> data,
        ...
        result.size_endian = CheckBigEndian32(data, address + 4u) ? ::spice::modeling::Structs::Endian::Big : ::spice::modeling::Structs::Endian::Little;
        ::spice::modeling::Structs::EndianStackReader headerReader(data, ::spice::modeling::Structs::Endian::Little);
        ::spice::modeling::Structs::EndianStackReader sizeReader(data, result.size_endian);
    ...
    [[nodiscard]] static bool CheckBigEndian32(std::span<const std::byte> data, std::uint32_t address) {
        ...
        const ::spice::modeling::Structs::EndianStackReader little(data, ::spice::modeling::Structs::Endian::Little);
        const ::spice::modeling::Structs::EndianStackReader big(data, ::spice::modeling::Structs::Endian::Big);
