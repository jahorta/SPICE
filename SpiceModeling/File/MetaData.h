...
public:
    [[nodiscard]] static MetaData Read(std::span<const std::byte> data,
                                       ...
                                       spice::modeling::Structs::Endian endian = spice::modeling::Structs::Endian::Little) {
...
private:
    MetaDataReader(std::span<const std::byte> data, spice::modeling::Structs::Endian endian)
    ...
    [[nodiscard]] bool TryReadPointer(std::uint32_t address, std::uint32_t& value) const {
        const auto pointer = spice::modeling::Structs::PointerIO::read_nullable_pointer_add_base(reader_, address, imageBase_);
    ...
    [[nodiscard]] std::uint32_t ReadPointer(std::uint32_t address) const {
        return spice::modeling::Structs::PointerIO::read_pointer_add_base(reader_, address, imageBase_);
    }
    ...
    [[nodiscard]] std::uint64_t ReadULong(std::uint32_t address) const {
        ...
        if (reader_.endian() == spice::modeling::Structs::Endian::Little) {
            return low | (high << 32);
        }
    ...
    spice::modeling::Structs::EndianStackReader reader_;
