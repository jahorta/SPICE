...
public:
    ...
    spice::modeling::Structs::Bounds mesh_bounds {};
    ...
    [[nodiscard]] static AttachPtr read(const spice::modeling::Structs::EndianStackReader& reader,
...
protected:
    [[nodiscard]] static std::optional<std::uint32_t> read_pointer(
        ...
        return spice::modeling::Structs::PointerIO::read_nullable_pointer_subtract_base(reader, address, imageBase);
    }
};
