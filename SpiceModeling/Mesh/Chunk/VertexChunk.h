...
namespace spice::modeling::Mesh::Chunk {
...
public:
    ...
    [[nodiscard]] static VertexChunk read(const spice::modeling::Structs::EndianStackReader& reader,
        ...
        for (auto& vertex : result.vertices) {
            vertex.position = spice::modeling::Structs::EndianIOExtensions::read_vector3(reader, address);
            address += vec4;

            if (!hasNormal) {
                vertex.normal = spice::modeling::Structs::Vector3::unit_y();
            } else if (normal32) {
                ...
                vertex.normal = spice::modeling::Structs::EndianIOExtensions::read_vector3(reader, address);
                address += vec4;
            }
            ...
            case VertexChunkType::Normal32Diffuse:
                vertex.diffuse = spice::modeling::Structs::EndianIOExtensions::read_color(
                    reader, address, spice::modeling::Structs::ColorIOType::ARGB8_32);
                break;
            case VertexChunkType::DiffuseSpecular5:
            case VertexChunkType::NormalDiffuseSpecular5:
                vertex.diffuse = spice::modeling::Structs::EndianIOExtensions::read_color(
                    reader, address, spice::modeling::Structs::ColorIOType::RGB565);
                vertex.specular = spice::modeling::Structs::EndianIOExtensions::read_color(
                    reader, address, spice::modeling::Structs::ColorIOType::RGB565);
                break;
            case VertexChunkType::DiffuseSpecular4:
            case VertexChunkType::NormalDiffuseSpecular4:
                vertex.diffuse = spice::modeling::Structs::EndianIOExtensions::read_color(
                    reader, address, spice::modeling::Structs::ColorIOType::ARGB4);
                vertex.specular = spice::modeling::Structs::EndianIOExtensions::read_color(
                    reader, address, spice::modeling::Structs::ColorIOType::RGB565);
                break;
            case VertexChunkType::Intensity:
            case VertexChunkType::NormalIntensity:
                vertex.diffuse = spice::modeling::Structs::Color(0, 0, 0);
                vertex.specular = spice::modeling::Structs::Color(0, 0, 0);
                address += 4u;
                break;
