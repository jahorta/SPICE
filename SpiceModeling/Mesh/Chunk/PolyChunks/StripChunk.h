...
public:
    std::vector<spice::modeling::Mesh::Chunk::Structs::ChunkStrip> strips;
    ...
    [[nodiscard]] static StripChunk read(const spice::modeling::Structs::EndianStackReader& reader,
        ...
        for (auto& strip : result.strips) {
            strip = spice::modeling::Mesh::Chunk::Structs::ChunkStrip::read(
